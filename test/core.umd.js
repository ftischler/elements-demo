...
(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     *
     * ```
     * renderComponent(GreeterComponent, {features: [RootLifecycleHooks]});
     * ```
     */
     ...
     * import { GreeterModule } from './app/app.module';
     *
     * platformBrowserDynamic().bootstrapModule(GreeterModule, {
     ...
     * `GreeterModule` when you create a new app with the CLI `new` command.
     *
     * @publicApi
     */
